// cogmanII planner — cli/args.rs
// This module exists because argument parsing is a surface concern.
...
#[command(
    name = "cogmanII",
    about = "CogmanII planner — TOML metadata to binary execution plan",
    version
)]
pub struct Cli {
    #[command(subcommand)]
