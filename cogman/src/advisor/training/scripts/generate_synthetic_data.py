"""
cogman/src/advisor/training/scripts/generate_synthetic_data.py - Data Augmentation

This script generates synthetic build failures and diagnostic 
scenarios to enrich the training dataset for the Cogman AI.

Why: To expose the model to rare or edge-case failure modes that 
are difficult to capture from real-world usage.
"""
import json
import random
