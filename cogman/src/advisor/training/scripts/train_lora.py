"""
cogman/src/advisor/training/scripts/train_lora.py - Model Fine-Tuning Pipeline

This script implements the QLoRA training loop for Cogman-1B/2B models, 
specializing them on the Rogue Linux architecture and build systems.

Why: To ensure the AI Advisor possesses deep, localized expertise 
that standard pre-trained models lack.
"""
...
model_name = "unsloth/Llama-3.2-1B-Instruct-bnb-4bit" # 1B - Fast & Low Memory
output_dir = "cogman_adapter"
DEBUG_DATA = "data/debug_data_100.json"
